const jpData = {
    translation: {
        ...
        ACCOUNT_BALANCE: 'あなたの XRP Tip Bot 残高は: %s XRPです。なにかお困りでしょうか。 ',
        ...
        ASK_FOR_AMOUNT_CONFIRMATION: '%s XRPで合っていますか? ',
        ...
        ASK_FOR_USER_CONFIRMATION: ' %sのユーザー%sで間違いありませんか？ ',
        ASK_FOR_USER_FALLBACK: '申し訳ございません。確認できませんでした。ユーザー名を指定して....へ送信ではじめてください。',
        TIP_CONFIRMATION: 'あなたは%s XRP をユーザー %s へ送信します。よろしいですか？',
        TIP_SENT_RESPONSE: '%s XRPは %s .へ送信されました',
        ...
        RESPONSE_ERROR_401_WITH_AMOUNT: ' %s XRPを送信するには残高が不足しています。残高をいっぱいにしてもう一度試してください。',
